...
export enum GqlHookType {
    AKRON = 'AKRON',
    DIRECTIONAL_FEE = 'DIRECTIONAL_FEE',
    EXIT_FEE = 'EXIT_FEE',
    FEE_TAKING = 'FEE_TAKING',
    FIXED_LBP = 'FIXED_LBP',
    LBP = 'LBP',
    LOTTERY = 'LOTTERY',
    MEV_TAX = 'MEV_TAX',
    NFTLIQUIDITY_POSITION = 'NFTLIQUIDITY_POSITION',
    RECLAMM = 'RECLAMM',
...
export enum GqlPoolAprItemType {
    ...
    DYNAMIC_SWAP_FEE_24H = 'DYNAMIC_SWAP_FEE_24H',
    ...
    MABEETS_EMISSIONS = 'MABEETS_EMISSIONS',
    ...
    QUANT_AMM_UPLIFT = 'QUANT_AMM_UPLIFT',
...
export type GqlPoolFilter = {
    ...
    reviewedOnly?: InputMaybe<Scalars['Boolean']>;
    /**
...
export enum GqlTokenChartDataRange {
    ...
    ONE_HUNDRED_EIGHTY_DAY = 'ONE_HUNDRED_EIGHTY_DAY',
    ONE_YEAR = 'ONE_YEAR',
    SEVEN_DAY = 'SEVEN_DAY',
